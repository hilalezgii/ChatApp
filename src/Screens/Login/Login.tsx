...
const Login: React.FC = () => {
    ...
    return (
        <View className="flex-1">
            ...
            <View style={{ backgroundColor: 'white', paddingTop: hp(8), paddingHorizontal: wp(5) }} className="flex-1 gap-12">
                <View className="items-center">
                    <Image style={{ height: hp(25) }} resizeMode="contain" source={require('../../Assets/loginImage.jpg')} />
                </View>
                <View className="gap-10">
                    <Text style={{ fontSize: hp(4), textAlign: 'center' }} className="font-bold tracking-wider text-neutral-800">
                        Sign In
                    </Text>
